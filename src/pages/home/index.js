    ...
    <div className="m-0 p-0">
      ...
      <div className="relative min-h-screen">
        ...
        <div className=" lg:block hidden">
          ...
          <div className="lg:w-[570px] lg:h-[522px] lg:ml-[145px] lg:mt-[171px] lg:text-left">
            <Bgcontent
              ...
              text2="The beauty collection that makes all the difference!"
              text3="Aliquam vulputate, nunc vitae suscipit aliquet, libero arcu hendrerit sapien."
              hc="#4682B4"
              bhc="#1C3D5A"
            />
          </div>
        ...
        <div className="bg-white lg:h-[851px] md:h-[851px] lg:w-[100%] md:w-[361px] w-[97%] px-5 lg:pt-16 md:pt-16 pt-12 lg:pl-24 md:pl-14 pl-7">
          <div>
            ...
            <h2
              ...
              className="lg:w-[41%] md:w-[331px] lg:text-[2.5875rem] md:text-[1.875rem] text-[31px] font-serif font-thin"
            >
        ...
        <div className="w-[100%] bg-white lg:flex md:flex hidden justify-evenly pt-3 pb-0">
          <div
            className="h-[451px] lg:w-[47%] md:w-[45%] w-[91%] bg-cover bg-ceter-top shadow-inner"
            style={{
          ...
          >
            <div
              className="lg:w-[43%] lg:h-[222px] lg:ml-[63px] lg:mt-[63px] lg:text-left
          ...
          <div
            className="h-[451px] w-[47%] bg-cover bg-ceter-top shadow-inner"
            style={{
        ...
        <div className="w-screen bg-white pt-0 pb-11 lg:hidden md:hidden block">
          <div
            className="h-[331px] w-[91%] bg-cover bg-left shadow-inner mx-auto"
            style={{
              backgroundImage: `url(${bgimage3})`,
              boxShadow: "inset 0 0 15px rgba(0, 0, 0, 0.3)",
            }}
