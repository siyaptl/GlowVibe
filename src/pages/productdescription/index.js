  ...
  return (
    <>
      ...
      <ArrowBackOutlinedIcon
        ...
        className="absolute lg:top-[95px] md:top-[85px] top-[71px] left-5 text-gray-500 z-50 cursor-pointer hover:text-gray-700 transition-all duration-300 ease-in-out"
      ...
      <div className="flex justify-center items-center lg:mt-[110px] mt-16 md:mt-[71px]">
        <div className="lg:w-[83%] md:w-[85%] w-[91%] flex md:flex-col lg:flex-row flex-col">
          ...
          <div className="lg:w-1/2 lg:p-3 lg:ml-7 pl-2 md:mt-7 mt-7 lg:mt-0">
            <p className="text-sm text-gray-500 mb-5 tracking-widest">
              <span>
                {" "}
                <Link to="/">Home</Link>
              </span>{" "}
              /{" "}
              <span>
                <Link to="/skincare">{product.category}</Link>
              </span>{" "}
              / {product.name}
            </p>
            <p className="text-base text-gray-700 mb-3 tracking-wider">
              {product.category}
            </p>
            <h1 className="text-3xl font-serif tracking-wider mb-3">
              {product.name}
            </h1>
            <p className="text-[21px] text-gray-700 mt-2">
              ...
              <span className="text-[13.5px] tracking-wider">
                {" "}
                & Free Shipping{" "}
              </span>
            </p>
            ...
            <p className="text-gray-600 mt-4 font-light text-[16px] tracking-wider leading-[25px] mr-16">
            ...
            <div className="flex items-center mt-6 space-x-4">
              ...
              <button
                onClick={() => {
                  if (
                    window.confirm(
                      `'${product.name}' will be added to the cart!`
                    )
                  ) {
                    addToCart();
                  }
      ...
      <div className="w-[85%] mt-16 mx-auto">
        ...
        <div className="mt-10 pb-7">
          {activeTab === "description" ? (
            <div>
              <h2 className="text-[33px] mb-3 font-serif tracking-wider text-gray-900">
              ...
              <div
                className="lg:w-full md:bg-center p-6 flex justify-center items-center relative h-[412px] lg:h-[652px] md:h-[712px] bg-center bg-cover mt-9 brightness-110"
                style={{ backgroundImage: `url(${belowdescription})` }}
              >
                <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6 bg-black/30">
                  <div className="lg:mt-[331px] md:mt-[331px] mt-[211px]">
                    ...
                    <h2 className="lg:text-3xl text-xl tracking-widest lg:w-[85%] mx-auto md:text-2xl md:w-[95%] font-serif font-thin leading-snug mt-3">
                      Cras vehicula semper ex, et fermentum tortor varius eget
                ...
                <div className="lg:w-1/2 md:w-1/2 w-full lg:mt-0 md:mt-0 mt-5">
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div className="flex items-center border-t pt-3">
                      ...
                      <p className="ml-3 text-gray-700 tracking-wider">
            ...
            <div className=" bg-white rounded-lg mx-auto lg:mb-0 md:mb-0 mb-11 ">
              ...
              <form onSubmit={handleSubmit} className="mt-4 border px-7 py-5">
                <label className="block font-medium text-[21px] text-slate-600">
                  Add a review{" "}
                </label>
                <label className="block font-medium text-[17px] text-slate-500 mt-1 tracking-wider">
                  Your email address will not be published. Required fields are
                  marked *{" "}
                </label>
                <div className="flex mt-5">
                  <label className="block font-medium text-[19px] text-slate-600 tracking-wider">
                    Your rating *{" "}
                  </label>
                ...
                <label className="block font-medium text-[19px] text-slate-600 mt-3 mb-1 tracking-wider">
                  Your review *{" "}
                </label>
                <textarea
                  value={review}
                ...
                <div className="flex flex-col lg:flex-row md:flex-row lg:space-x-4 md:space-x-4">
                  <div className="lg:w-1/2 md:w-1/2 w-full">
                    <label className="block font-medium text-slate-600 tracking-wider mb-1">
                      Name *
                    </label>
                    <input
                      type="text"
      ...
      <div
        className="h-[571px] w-[91%] bg-cover bg-left shadow-inner mx-auto mb-11"
        style={{
          backgroundImage: `url(${krudes})`,
