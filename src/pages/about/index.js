  ...
  return (
    <>
      ...
      <div className="w-[100%] bg-white lg:flex md:flex hidden justify-evenly pb-0">
        <div
          className="h-[511px] lg:w-[98%] md:w-[96%] w-[99%] bg-cover bg-bottom"
      ...
      <div className="flex flex-col md:flex-row justify-between items-start lg:px-12 lg:pt-12 md:px-12 md:pt-12 pt-1 lg:mt-7 pb-5 px-5">
        ...
        <div className="lg:w-[46%] w-full md:w-[55%] bg-lightPink md:p-12 p-7 bg-[#FFF2F4] lg:px-[91px] lg:py-[85px] lg:mr-14 lg:mt-[-95px] md:mr-[-13px] md:mt-[-65px] mt-7 pt-11 pb-11">
          <h2 className="font-playfair text-[17px] lg:text-[22px] lg:leading-7 md:leading-6 leading-[22px] md:text-[20px] text-gray-800 lg:tracking-wide md:tracking-wide tracking-normal">
            Cras ut ultricies risus. Etiam ac malesuada lectus. Sed congue nisi
            vitae lorem ullamcorper laoreet. In eget tellus mauris. Phasellus id
            ligula.
          </h2>
      ...
      <div className="w-[100%] bg-white flex justify-center items-center pb-7 lg:h-[671px] md:h-[541px] h-[525px]">
        <div
          className="lg:h-[100%] md:h-[100%] h-[100%] w-[90%] bg-cover bg-center"
          style={{ backgroundImage: `url(${aboutimg2})` }}
        >
          <div className="lg:pt-16 md:pt-24 pt-[25%] flex items-center lg:mt-24 flex-col">
            <div className="text-[#FFFFFF] drop-shadow-md lg:text-[45px] md:text-[41px] text-[29px] leading-[45px] font-serif ... font-normal">
              About Our Products
            </div>
            <hr className="w-14 border-t-1 border-white md:mx-auto mx-auto lg:my-5 md:my-5 my-3" />
            <div className="text-[#FFFFFF] lg:w-[69%] md:w-[81%] w-[85%] lg:text-[24px] md:text-[19px] text-[18.5px] font-serif ... lg:leading-[27.25px] md:leading-[27.25px] leading-[24.25px] text-center tracking-wide">
              Proin at velit sed elit varius porttitor. Ut a suscipit quam, eu
              congue odio. Sed eget viverra est. Vivamus ut sodales neque. Sed
              vel dui et dolor placerat egestas id lacinia mauris
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:flex lg:flex-row md:flex-row md:flex flex flex-col-reverse items-center lg:h-[711px] lg:bg-[#FFF0F5] md:bg-[#FFF0F5] h-[8901x] brightness-95 w-[90%] mx-auto">
        ...
        <div className="md:w-1/2 w-full bg-[#FFF0F5] lg:bg-none md:bg-none text-center md:text-right lg:text-right lg:pr-20 lg:pt-[7%] md:pt-[9%] pt-11 md:text-[13px] pb-5">
          ...
          <h1
            className="lg:text-[41px] md:text-[37px] text-[31px] text-gray-800  md:pr-5"
