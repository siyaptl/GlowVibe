...
function Cart() {
  ...
  <div className="text-center mt-10 text-gray-500 text-2xl">
        ...
        <table className="w-full border-slate-300">
          ...
          <tbody>
            ...
            <tr key={index} className="h-28">        
              <td className="p-3">
              <button onClick={() => handleRemoveItem(index)} className="text-gray-400 border border-gray-400 hover:text-gray-500 hover:border-gray-500 ml-7 h-7 w-7 text-2xl flex items-center justify-center">
                    &times;
                  </button>
              </td>
    ...
    <div className="container w-[100%] mx-auto p-4 mt-3 lg:hidden md:flex md:flex-col flex flex-col">
      <p className="text-4xl tracking-wide font-serif text-gray-800 mb-5">Cart</p>
      ...
      <div className="w-full overflow-x-auto">
        ...
        <div className="text-center">
          ...
          <div className="w-full flex justify-between p-3 border-y-[1px]">
            ...
            <span className="text-right tracking-wider">Product Name 15</span>
          </div>
          <div className="w-full flex justify-between p-3 border-y-[1px]">
            <span className="text-left text-gray-700 tracking-wider">Price : </span>
            <span className="text-right tracking-wider text-gray-700">$59.00</span>
          </div>
          <div className="w-full flex justify-between p-3 border-y-[1px]">
          ...
          <div className="w-full flex justify-between p-3 border-y-[1px]">
            ...
            <span className="text-right tracking-wider text-gray-700">$118.00</span>
          </div>
        </div>
      </div>

      {/* Coupon and Update Section medium screen */}
      <div className="md:flex hidden flex-row lg:flex-row border-x-[1px] border-b-[1px] p-3 justify-between">
  <div className="flex">
    <input
      type="text"
      placeholder="Coupon code"
  ...
  <button className="bg-gray-500 text-white px-6">
    ...
    {/* small screen */}
      <div className="flex md:hidden flex-col lg:flex-row justify-between mt-3 space-y-3">
