    ...
    <div className="bg-white lg:pb-5 md:pb-5 pb-5">
      <footer className="bg-pink-50 text-gray-800 mx-5 pt-7">
        ...
        <div className="container mx-auto px-5 lg:pl-14 md:pb-3 lg:flex md:flex block">
          <h2 className="text-lgh2 font-serif lg:text-2xl lg:block md:block lg:pb-0 md:pb-0 pb-5 flex justify-center md:text-xl text-2xl font-light tracking-wide lg:py-5 md:mt-[15px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:gap-8 text-center md:text-left lg:pl-11">
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-rows-1 lg:ml-[51%] lg:w-[311px] md:ml-20 md:w-[275px]">
              <ul className="space-y-1 lg:mt-3 md:mt-4">
                <li>
                  <a href="/shopall" className="hover:text-gray-500">
                    Shop All
                  </a>
                </li>
                <li>
                  <a href="/makeup" className="hover:text-gray-500">
                    Makeup
                  </a>
                </li>
                <li>
                  <a href="skincare" className="hover:text-gray-500">
                    Skin Care
                  </a>
                </li>
                <li>
            ...
            <div className="w-[71%] md:w-[91%] lg:w-[71%] mx-auto flex justify-center md:justify-start lg:space-x-5 md:space-x-[1px] space-x-1 pb-5 lg:ml-5 md:pl-[43%] md:pt-[11px] lg:pt-[1px] pt-3">
              <button
                ...
                className="text-gray-900 hover:text-pink-300 text-xl"
              >
