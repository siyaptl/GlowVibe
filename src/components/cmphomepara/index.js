...
function Parawstar() {
  return (
    <div className='mb-5'>
                      ...
                      <p className='lg:w-[491px] md:w-[351px] w-[83%] text-gray mt-3 tracking-wider'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus posuere tincidunt purus, eu consectetur eros sodales nec. Maecenas ac erat pretium, ultricies nibh quis, mattis massa.</p>
                      <p style={{ 
